...
function removeFirstOccurrences(str, value) {
  ...
  return `${str.substring(0, valueIndex)}${str.substring(
...
function encodeToRot13(str) {
  const straight = 'ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz';
  const ciphered = 'NOPQRSTUVWXYZABCDEFGHIJKLMnopqrstuvwxyzabcdefghijklm';
  return str.replace(/[a-z]/gi, (char) => ciphered[straight.indexOf(char)]);
}
